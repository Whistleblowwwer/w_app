      ...
      children: [
        GestureDetector(
          onTap: () async {
            ...
            if (review.ad?.clickUrl != null) {
              final Uri url = Uri.parse(review.ad!.clickUrl);
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      //           sizeText: 18,
                      //           urlImage:
                      //               review.business?.profilePictureUrl ?? '',
                      //         ),
                      //       ),
                      //       // Positioned(
                      //       //   bottom: 0,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Visibility(
                              visible:
                                  (review.ad?.description ?? '').isNotEmpty,
                              child: Padding(
                                padding: const EdgeInsets.only(
                                    left: 16, right: 18, bottom: 8),
                                child: Linkify(
                                  onOpen: (link) async {
                            ...
                            if (review.images?.isNotEmpty ?? false)
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  // ),
                                  height:
                                      review.images!.length == 1 ? null : 256,
                                  width: double.maxFinite,
                                  decoration: BoxDecoration(
